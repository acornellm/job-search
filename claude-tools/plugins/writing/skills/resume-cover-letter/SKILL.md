...
description: "Write a resume or cover letter tailored to a specific role. Handles regional format for US, ATS-friendly formatting, achievement-focused bullets, and cover letter structure. Use whenever the user mentions a job application, resume, cover letter, career document, applying for a role, or needs help framing their experience for a specific job."
---

# Resume and Cover Letter Writer

Produces job application documents: a resume/CV, a cover letter, or both. Every output is tailored to a specific role at a specific company — generic documents are not useful. The resume's only goal is to get the candidate an interview for a specific position — not to document their full work history. Every decision should serve this goal. The reader (recruiter or hiring manager) will scan the resume for under 10 seconds on first glance.
...
3. **Region** — should always be US
4. **Candidate background** — master resume, current role, years of experience, key skills, education, career highlights
5. **Special circumstances** (if any) — career change, employment gap, overqualified, underqualified, relocation

If the user provides a job listing, extract the key requirements, keywords, skills and tailor everything to match them. Mirror the language the listing uses for skills and responsibilities.
...
|---------|-------|----|----|
| Name | Resume | CV |
| Length | 2 max | 2 pages standard |
| Photo | No | No |
| Date of birth / age | No | No |
| Nationality / visa | No (discrimination risk) | Include visa status if applicable |
| Referees |  Omit | Omit |
| Address | City/State only | City only |
...
- File naming: "firstname-lastname-(resume|coverletter)-company.(pdf|docx)"
...
- Every job since high school — include only relevant roles
...
- Self-rated skill levels (bars, stars, percentages) — they always backfire
...
Mention specific technologies used, especially those in the job description. Talk about the candidate, not just the role — show proactivity and ownership.
...
### Languages & Technologies & Skills Section
...
Deliver the document(s) as clean markdown. If the user needs a formatted file, offer to create it as a .md or .txt that they can paste into their preferred tool (Google Docs, Word, Canva). Do not attempt to generate .docx or .pdf files directly unless they request it.
...
Provide an ATS match score out of 100 before and after.

Flag relevant experience I have not highlighted as well as missing experience I may want to invest time into learning/improving.

Include a draft of an outreach message to a potential recruiter/hiring manager for this position that is brief, confident and friendly similar to the cover letter.  Two formats: a LinkedIn optimized note and a full outreach message.
